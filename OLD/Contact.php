...
<body>
        ...
        <nav class="navbar">
            ...
            <div class="nav-links">
                <ul>
                    ...
                    <li><a href="Passions.html">Centres d'intérêt</a></li>
    ...
    <div class="contact">
        ...
        <div class="contact-form">
            ...
            <p>Je suis disponible par télephone au : <a href="tel:+33651150123">06 51 15 01 23</a> ou par mail ici :</p>
            <form method="post">
    ...
    if (isset($_POST['message'])) {
        $message = "Message envoyé depuis la page Contact de votre Portfolio :
...
Message : " . $_POST['message'];
    ...
    <footer>
        <div class="social">
            ...
            <a href="https://github.com/Tiboww"><i class="fab fa-github"></i></a>
